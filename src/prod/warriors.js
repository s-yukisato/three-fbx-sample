...
function init() {
    ...
    loader.load('../../three-fbx-sample/models/fbx/Warrior.fbx', function (object) {
        warrior = object;
        mixer.warrior = new THREE.AnimationMixer(warrior);
        
        const texture = textureLoader.load('../../three-fbx-sample/models/texture/Warrior_Texture.png');
    ...
    loader.load('../../three-fbx-sample/models/fbx/Ranger.fbx', function (object) {
        ranger = object;
        mixer.ranger = new THREE.AnimationMixer(ranger);
        
        const texture = textureLoader.load('../../three-fbx-sample/models/texture/Ranger_Texture.png');
